 ...
 * @author ezio_joao
 */
public class PesquisarCategoriaProduto extends javax.swing.JFrame {

    private JTable tabela;
    private DefaultTableModel tabelmodelo = new DefaultTableModel();

    public PesquisarCategoriaProduto() {
        initComponents();
        criaJTable();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(31, 31, 31)
                        .addComponent(txPesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 374, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(204, 204, 204)
    ...
    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            int idCategoriaProduto = (int) tabela.getValueAt(linhaSelecionada, 0);
            CategoriaProdutoController cpc = new CategoriaProdutoController();
            if (cpc.remover(idCategoriaProduto)) {
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        CadastrarCategoriaProdutoGUI ccp = new CadastrarCategoriaProdutoGUI(tabelmodelo);
    ...
    private void btAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAtualizarActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            int idCategoriaProduto = (int) tabela.getValueAt(linhaSelecionada, 0);
            CadastrarCategoriaProdutoGUI ccp = new CadastrarCategoriaProdutoGUI(tabelmodelo, linhaSelecionada, idCategoriaProduto);
            ccp.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "Nenhuma linha foi selecionada.");
        }
    ...
    private void txPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txPesquisarActionPerformed
        ...
        for (CategoriaProduto cp : cpc.listByNome(nome)) {
    ...
    private void criaJTable() {
        ...
        tabelmodelo.addColumn("Descrição");        
        preencherJTable();
    }
    ...
    private void preencherJTable() {
        ...
        for (CategoriaProduto cp : cpc.listAll()) {
            tabelmodelo.addRow(new Object[]{cp.getCodigo(), cp.getNome(), cp.getDescricao()});
        }
    }
}
